...
import 'package:tasbeeh_app/features/home/data/datasources/activity_local_data_source.dart';
...
class ActivityRepositoryImpl implements ActivityRepository {
  ...
  Future<Either<Failure, void>> incrementActivity(int id) async {
    try {
      await localDataSource.incrementActivity(id);
      return const Right(null);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    } on UnexceptedException catch (e) {
  ...
  Future<Either<Failure, void>> resetActivity(int id) async {
    try {
      await localDataSource.resetActivity(id);
      return const Right(null);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    } on UnexceptedException catch (e) {
